...
* **Protocol & Timing:** Custom 34-bit direct-binary protocol operating at noise-resistant 10 Hz. Uses a 200 ms start pulse, followed by 34 data bits (50 ms pulse / 50 ms gap per bit). 
